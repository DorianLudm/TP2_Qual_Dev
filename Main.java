...
class Main {
  public static void main(String[] args) {
    ...
    Journée jour = new Journée(Style.DRAME, Style.COMÉDIE);
    jour.creeEpreuveMatin();
    assert jour.getStyleMatin() == Style.DRAME;
    assert jour.getStyleSoir() == Style.TRAGÉDIE;
    ...
    assert aristophane.pointFort() == Style.COMÉDIE;
    assert euripide.pointFort() == Style.TRAGÉDIE;
