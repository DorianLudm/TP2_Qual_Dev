...
class Auteur {
  ...
  int qualitéTragédie;
  String citationTragédie;
 
  int qualitéComédie;
  String citationComédie;
  ...
  public Auteur(
      ...
      String citationDrame) {
        this.nom = nom;
        this.qualitéTragédie = qualitéTragédie;
        this.citationTragédie = citationTragédie;
        this.qualitéComédie = qualitéComédie;
        this.citationComédie = citationComédie;
        this.qualitéDrame = qualitéDrame;
        this.citationDrame = citationDrame;
  }

  public String toString(){
    return this.nom +" : Tragédie : " + this.qualitéTragédie + " Comédie : " + this.qualitéComédie + " Drame : " + this.qualitéDrame ;
  }

  public int getQualitéTragédie(){
    return this.qualitéTragédie;
  }

  public String getCitationTragédie(){
    return this.citationTragédie;
  }

  public int getQualitéComédie() {
    return this.qualitéComédie;
  }

public String getCitationComédie() {
    return this.citationComédie;
}

private int getQualitéDrame() {
  return this.qualitéDrame;
}
...
public Style pointFort() {
  int comédie = getQualitéComédie();
  int tragédie = getQualitéTragédie();
  int drame = getQualitéDrame();
  List<Integer> intList = Arrays.asList(comédie,tragédie,drame);
  int idxMax = intList.indexOf(intList.stream()
                                      .reduce(Integer::max)
                                      .orElse(-1)
                            );
  return Style.values()[idxMax];
}

public int getQualitéStyle(Style style) {
  switch(style){
    case COMÉDIE:
      return this.getQualitéComédie();
    case TRAGÉDIE:
      return this.getQualitéTragédie();
    case DRAME:
      return this.getQualitéDrame();
    default:
      return -1;
  }
}

public static ArrayList<Auteur> lesAuteurs(){
  String citation_antigone =
    ...
    lesAuteurs.add(aristophane);
    lesAuteurs.add(euripide);
    lesAuteurs.add(sophocle);
    return lesAuteurs;
}
